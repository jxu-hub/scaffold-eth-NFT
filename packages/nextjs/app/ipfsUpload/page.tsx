  ...
  return (
    <>
      <div className="flex items-center flex-col flex-grow pt-10">
        ...
        {uploadedIpfsPath && (
          <div className="mt-4">
            <a href={`https://apricot-fantastic-ferret-743.mypinata.cloud/ipfs/${uploadedIpfsPath}`} target="_blank" rel="noreferrer">
              {`https://apricot-fantastic-ferret-743.mypinata.cloud/ipfs/${uploadedIpfsPath}`}
            </a>
          </div>
        )}
      </div>
